// Sample recipient data stored in localStorage
...
function addRecipient(RecipientName, RecipientAge, BloodType, Contact) {
    ...
    localStorage.setItem('recipients', JSON.stringify(recipients)); // Save to localStorage
...
function deleteRecipient(index) {
    ...
    localStorage.setItem('recipients', JSON.stringify(recipients)); // Update localStorage
    renderRecipients();
}
...
// Initial render of recipients when the page loads
renderRecipients();
